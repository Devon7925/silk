...
`;
    ...
    const { len_rotated_squared } = (await compileToInstance(silkCode, "structs_len")).exports as any;
...
`;
    ...
    const { sum_coords } = (await compileToInstance(silkCode, "structs_flow")).exports as any;
