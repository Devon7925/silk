...
Deno.test("return exits a function early", async () => {
    ...
    const exports = (await compileToInstance(silkCode, "return_early")).exports as any;
...
Deno.test("return inside let binding expressions still exits early", async () => {
    ...
    const exports = (await compileToInstance(silkCode, "return_let")).exports as any;
...
Deno.test("return doesn't break branch type matching", async () => {
    ...
    const exports = (await compileToInstance(silkCode, "return_branch")).exports as any;
...
Deno.test("returning a complex expression works", async () => {
    ...
    const exports = (await compileToInstance(silkCode, "return_complex")).exports as any;
