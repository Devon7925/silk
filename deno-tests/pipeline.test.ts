...
Deno.test("pipeline forwards values into functions", async () => {
    ...
    const exports = (await compileToInstance(silkCode, "pipeline_simple")).exports as any;
...
Deno.test("pipeline composes multiple functions", async () => {
    ...
    const exports = (await compileToInstance(silkCode, "pipeline_chain")).exports as any;
...
Deno.test("pipeline accepts inline function literals", async () => {
    ...
    const exports = (await compileToInstance(silkCode, "pipeline_literal")).exports as any;
